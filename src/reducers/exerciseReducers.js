...
export const exerciseCreateReducer = (state = mutationInitialState, action) => {
  switch (action.type) {
    case EXERCISE_CREATE_REQUEST:
      return { ...state, loading: true, success: false, error: null }
    case EXERCISE_CREATE_SUCCESS:
      return { loading: false, success: true, error: null, exercise: action.payload }
    case EXERCISE_CREATE_FAIL:
      return { ...state, loading: false, success: false, error: action.payload }
    case EXERCISE_CREATE_RESET:
      return mutationInitialState
    default:
      return state
  }
}

export const exerciseUpdateReducer = (state = mutationInitialState, action) => {
  switch (action.type) {
...
export const exerciseDeleteReducer = (state = mutationInitialState, action) => {
  switch (action.type) {
